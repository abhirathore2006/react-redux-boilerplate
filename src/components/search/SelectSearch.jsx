...
class Component extends React.Component {
    ...
    onBlur() {
        ...
        this.setState({focus: false, highlighted: null, search: search,options:this.state.defaultOptions});
    }
    ...
    chooseOption(value) {
        ...
        let options = (this.props.multiple) ? this.state.options:this.state.defaultOptions;
    ...
    removeOption(value) {
        ...
        let search =  this.props.multiple?this.state.search :''
        this.setState({value: value, search: search});
    ...
    render() {
        ...
        return (
            <div className={className} ref="container">
                {this.state.focus && this.renderOutElement()}
                {this.renderSearchField()}
                {this.state.focus && this.renderOptions()}
            </div>
        );
    }
